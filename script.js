...
// Set minimum date to today (future dates only)
...
// Force time picker to show hour intervals only
const timeInput = document.getElementById('time');
timeInput.step = 3600; // 1 hour increments
...
function moveNoButton() {
    ...
    const maxY = card.height - noBtn.offsetHeight - 20;
...
// Mobile (Instagram, Chrome, Safari)
